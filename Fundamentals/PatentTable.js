...
const PatentTable = (props) => {
	...
	return (
		<>
            <text style={{ fontSize: 14, color: 'grey', marginBottom: 10 }}>Patent Table</text>
                    ...
                    <div className='table-responsive-lg text-center'>
                        <table className='table table-classic table-hover'>
                            <thead className='insiderhead bg-primary'>
                                <tr>
                                    <th colSpan='1'>Molecule</th>
                                    <th colSpan='1'>Composition Patient</th>
                                    <th colSpan='1'>Extension</th>
                                    <th colSpan='1'>Other Patents</th>
                                    <th colSpan='1'>Extension</th>
                                    <th colSpan='1'>IP Text</th>
                                </tr>
                            </thead>
                            <tbody>
                                {trials?.map((trial) => (
                                    <tr key={Math.random()}>
                                        <td>
                                            <a href='#'>{trial?.ticker}</a>
                                        </td>
                                        <td>{trial?.composition_patent}</td>
                                        <td>{trial?.composition_patent_expiration}</td>
                                        <td>{trial?.other_patent}</td>
                                        <td>{trial?.other_patent_expiration}</td>
                                        <td>{trial?.ip_text.slice(0,15)}</td>
                                    </tr>
                                ))}
                            </tbody>
                        </table>
